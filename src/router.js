  ...
  return (<Router history={history}>
    <Route path="/">
      ...
      <Route path="/user" component={pages.Layout} onEnter={isLogin}>
        ...
        <Route path="/user/addrelation" component={pages.AddRelation} breadcrumbName="添加成员" />
        <Route path="/user/myappoint" component={pages.MyAppoint} breadcrumbName="我的预约" />
        <Route path="/user/cancelreason" component={pages.CancelReason} breadcrumbName="取消预约" />
      ...
      <Route path="/common">
        ...
        <Route path="/common/doctors/appoint" component={pages.DoctorAppoint} breadcrumbName="预约" />
